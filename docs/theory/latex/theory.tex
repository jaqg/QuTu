...
mode. Four basis-set representations are developed in full detail:
...
(III)~Gaussian basis functions, and (IV)~the Fourier Grid Hamiltonian
(DVR). For each basis, all Hamiltonian matrix elements are derived
...
%                       Sections
% ============================================================
\input{sections/01_potential}
\input{sections/02_variational}
\input{sections/03_HO_basis}
\input{sections/04_shifted_HO}
\input{sections/05_gaussian}
\input{sections/06_DVR}
\input{sections/07_comparison}
\input{sections/08_wavepackets}
\input{sections/09_observables}
\input{sections/10_numerical_impl}
\input{sections/11_additional_obs}
\input{sections/12_summary}
\input{sections/13_multidim}
\input{sections/14_general_case}
