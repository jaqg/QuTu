%
% --- QuTu: extra packages not in base template ---
%
...
\setstretch{1.3}  % Interlineado personalizado (use \setstretch, not \spacing, in preamble)
...
\usepackage{makecell}
\usepackage{diagbox}  % diagonal cells: \diagbox[width=3em, height=3em, trim=l]{$n$}{$k$}; check https://ctan.org/pkg/diagbox/
...
\usepackage{physics}
% Note: braket removed — \bra, \ket, \braket are provided by physics and mybraket.sty
