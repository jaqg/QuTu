...
def actualizar(i):
    ...
    y0   =  Psi(x,t).real + E_tot
    iy0  =  Psi(x,t).imag + E_tot
    dy0  = dPsi(x,t).real + E_tot
    ...
    ax.plot(x_a0,V,label=r'$V\,(x)$',color='gray',lw=1)
...
# Guardar el archivo
# anim.save('videos/densidades_1_b={}.mp4'.format(b), fps=30, extra_args=['-vcodec', 'libx264'])
